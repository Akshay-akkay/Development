...
const requestHandler = (req, res) => {
  ...
  if (url === '/message' && method === 'POST') {
    ...
    return req.on('end', () => {
      ...
      fs.writeFile('message.text', message, 'utf8', (err) => {
        res.statusCode = 302;
